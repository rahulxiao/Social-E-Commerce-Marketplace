import { Controller, Delete, Get, Param, Post, Put, Query, ParseIntPipe } from '@nestjs/common';
...
export class ProductController {
    ...
    getProductsByCategory(
        ...
        return this.productService.getProductsByCategory(category, sort, limit, page);
    }
